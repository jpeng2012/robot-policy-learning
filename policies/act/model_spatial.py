...
class ACTDecoder(nn.Module):
    def __init__(
        ...
        self.hidden_dim=hidden_dim
         ...
         # 1x1 conv preserves spatial organization
        ...
        self.pos_embedding = PositionEmbeddingSine2D(
    ...
    def _image_tokens(
        ...
        pos = self.pos_embedding(feat)

        # Add explicit spatial location
        feat = feat + pos
    ...
    def forward(
        ...
        agent_token = self._image_tokens(
            agent_feat,
            self.agent_proj,
        )

        wrist_token = self._image_tokens(
            wrist_feat,
            self.wrist_proj,
        )
