...
class VisionBCModel(nn.Module):
    def __init__(
        ...
        input_dim = 512 * 2 * history_len + proprio_dim*history_len
...
dataset_path = "data/level3_dataset.npz"
save_path = "policies/vision_bc/vision_bc_level3.pth"
...
optimizer = torch.optim.AdamW([
    {
        "params": policy.agent_encoder.parameters(),
        "lr": 1e-5,
    },
    {
        "params": policy.wrist_encoder.parameters(),
        "lr": 1e-5,
    },
    {
