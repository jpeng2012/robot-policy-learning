...
checkpoint_path = "policies/vision_bc/vision_bc_level3.pth"
...
class VisionBCPolicy(nn.Module):
    def __init__(
        ...
        self.agent_encoder = resnet18(
            weights=weights
        )

        self.wrist_encoder = resnet18(
            weights=weights
        )
...
for episode in range(num_episodes):
    ...
    # Repeat first frame if history_len > 1
